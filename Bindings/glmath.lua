...
glm.mat4_create_translation = C._mat4_create_translation
glm.mat4_translate = C._mat4_translate
glm.mat4_create_rotation = C._mat4_create_rotation
glm.mat4_rotate = C._mat4_rotate
glm.mat4_create_scale = C._mat4_create_scale
glm.mat4_scale = C._mat4_scale

glm.mat4_perspective = C._mat4_perspective
glm.mat4_frustum = C._mat4_frustum
glm.mat4_ortho = C._mat4_ortho
glm.mat4_lookat = C._mat4_lookat

-- Create the metatables

glm.vec2_t = ffi.metatype("vec2_t",
{
	__call = C._printVec2,
	__add = function(a,b)
...
glm.vec3_t = ffi.metatype("vec3_t",
{
	__call = C._printVec3,
	__add = function(a,b)
		if type(b) == "number" then
...
glm.vec4_t = ffi.metatype("vec4_t",
{
	__call = C._printVec4,
	__add = function(a,b)
		if type(b) == "number" then
...
glm.quat_t = ffi.metatype("quat_t",
{
	__call = C._printQuat,
...
glm.mat4_t = ffi.metatype("mat4_t",
{
	__call = C._printMat4,
	__mul = C._mat4_mul,
	__eq = C._mat4_equals,
...
-- Matrix stack
glm.matrix_stack_t = ffi.metatype("matrix_stack_t",
{
	__index = {
...
glm.vec2 = C._vec2_create
glm.vec3 = C._vec3_create
glm.vec4 = C._vec4_create
glm.rgba = vec4
glm.quat = C._quat_createf

function glm.rgb(r,g,b,a)
	return glm.rgba(r,g,b, (a or 1))
end

glm.vec2_zero = C.GLMVec2_zero
glm.vec3_zero = C.GLMVec3_zero
glm.vec4_zero = C.GLMVec4_zero

glm.mat3_identity = C.GLMMat3_identity
glm.mat4_identity = C.GLMMat4_identity
glm.mat3_zero = C.GLMMat3_zero
glm.mat4_zero = C.GLMMat4_zero
